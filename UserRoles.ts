...
import { type PrivyUser, isPrivyUser } from '@/types/privy'
...
function isUserRole(role: string): role is UserRole {
  return ['trainee', 'experienced', 'lead', 'manager', 'owner'].includes(role as UserRole)
}
  ...
  useEffect(() => {
    ...
    const fetchUserRole = async () => {
      ...
      try {
        ...
        let userRole: UserRole = 'trainee' // Default role
